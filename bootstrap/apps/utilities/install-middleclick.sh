#!/usr/bin/env bash
# ~/.config/bootstrap/apps/utilities/install-middleclick.sh
# Purpose: Ensures middleclick cask is installed via Homebrew and records its version.
# Usage: Run via bootstrap.sh or directly with: bash ~/.config/bootstrap/apps/utilities/install-middleclick.sh
set -euo pipefail
