...
2. Dispatch that prompt to a sub-agent with the Agent tool.
...
- Right agent for the job. Explore for read-only search and mapping, Plan for design and architecture, general-purpose for execution, specialized agents when they fit.
