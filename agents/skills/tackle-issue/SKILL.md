---
name: tackle-issue
description: "Resolve a GitHub or GitLab issue end to end: understand it, decide whether a change is warranted, implement the smallest in-scope fix, verify with build/tests/lint, then hand over copy-pasteable push and PR/MR commands. Only create the PR/MR when explicitly asked. Use when the user says tackle this issue, resolve this issue, or pastes a GitHub/GitLab issue link asking for a fix. Works for bugs, features, refactors, docs, and questions."
---
